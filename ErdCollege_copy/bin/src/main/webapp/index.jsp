...
<html>
	...
	<body>
		...
		<c:if test="${empty sessUser}">
			<p>그린대학교에 오신 것을 환영합니다.<br/>
				수강신청을 하려면 로그인을 하시기 바랍니다.<br/>
				로그인을 해야 서비스를 이용할 수 있습니다.<br/>
			</p>
			<h4>로그인</h4>
			<form action="/ErdCollege_copy/student/login.do">
				<table border="1">
					<tr>
						<td>학번</td>
		...
		<c:if test="${not empty sessUser}">
			<p>${sessUser.stdName}(sessUser.stdNo)님 반갑습니다. 서비스를 이용하시기 바랍니다.<br/>
				<a href="/ErdCollege_copy/student/logout.do">로그아웃</a>
			</p>
