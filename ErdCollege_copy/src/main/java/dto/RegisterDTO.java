...
public class registerDTO {
	...
	public String toString() {
		return "registerDTO [regStdNo=" + regStdNo + ", regLecNo=" + regLecNo + ", regMidScore=" + regMidScore
				...
				+ ", getRegStdNo()=" + getRegStdNo() + ", getRegLecNo()=" + getRegLecNo() + ", getRegMidScore()="
				+ getRegMidScore() + ", getRegFinalScore()=" + getRegFinalScore() + ", getRegTotalScore()="
				+ getRegTotalScore() + ", getRegGrade()=" + getRegGrade() + ", getClass()=" + getClass()
