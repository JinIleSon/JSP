...
<html>
	...
	<body>
		...
		<h4>표현언어 내장객체</h4>
		<p>
			num1 : ${pageScope.num1}<br/> <!-- pageContext는 pageScope를 가지고 있음 -->
			num2 : ${requestScope.num2}<br/> <!-- request도 requestScope -->
			str1 : ${sessionScope.str1}<br/> <!-- session은 sessionScope -->
			str2 : ${applicationScope.str2}<br/> <!-- application은 applicationScope를 -->
			session num1 : ${sessionScope.num1}<br/> <!-- num1은 pageContext의 값이므로 출력x -->
		</p>
