...
<html>
	...
	<body>
		...
		<c:if test="${empty sessCustomer}">
			...
			<form action="/ErdBank/customer/login.do" method="post">
				<table border="1">
					<tr>
						<td>주민번호</td>
						<td><input type="text" name="c_no" placeholder="주민번호 입력하세요."/></td>
					</tr>
					<tr>
						<td>이름</td>
						<td><input type="text" name="c_name" placeholder="이름 입력하세요."/></td>
					</tr>
					<tr>
		...
		<c:if test="${not empty sessCustomer}">
			<p>
