	...
	<body>
		...
		<form action="/ch10/bank/customer/register.do" method="post">
			<table border="1">
				<tr>
					<td>계좌번호</td>
					<td><input type="text" name="c_id" placeholder="계좌번호 입력"/></td>
				</tr>
				<tr>
					<td>이름</td>
				...
				<tr>
					<td>타입</td>
					<td><input type="text" name="c_type" placeholder="타입 입력"/></td>
				</tr>
				<tr>
					<td>전화번호</td>
					<td><input type="text" name="c_hp" placeholder="전화번호 입력"/></td>
				</tr>
				<tr>
					<td>주소</td>
