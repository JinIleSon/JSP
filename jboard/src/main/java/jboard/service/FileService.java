...
public enum FileService {
	...
	public List<FileDTO> fildUpload(HttpServletRequest req) {
		...
		try {
			...
			for(Part part : parts) {
				...
				if(partName.equals("file1") || partName.equals("file2")) {
					...
					String savedName = UUID.randomUUID().toString() + ext; // 유니코드 ID로 생김	
	...
	public void fildDownload(HttpServletRequest req, HttpServletResponse resp, FileDTO fileDTO) {
